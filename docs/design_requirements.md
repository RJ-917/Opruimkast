...
|:---|:---|:---|:---:|
|**Discover**|
|1.1| Opruimen moet op een speelse en intuïtieve manier geïntegreerd worden in het spelen. |[1.1 Expert interview](url)|❌|
|1.2| De oplossing mag niet te complex zijn voor kinderen. |[2.1 User test](url)|⚠️|
|1.3| De kast moet toegankelijk en gebruiksvriendelijk zijn voor zowel kinderen als ouders. |[1.1 Expert interview](url)|❌|
