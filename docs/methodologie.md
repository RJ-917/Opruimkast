...
Tot slot werd een antropometrische analyse uitgevoerd (8–11 jaar) om de ergonomie te garanderen. De bakafmetingen zijn afgestemd op de reiklengtes van de doelgroep, zodat alle kinderen de kast comfortabel kunnen gebruiken. Deze inzichten werden verwerkt in een verfijnd prototype dat verder getest werd in usertests.

### Develop 3: Serviceontwerp en CMF
In deze slotfase van het ontwerpproces werden benchmarkanalyses van bestaande producten en user-analyses van zowel ouders als kinderen gebruikt om de gewenste UX en emoties te bepalen. Op basis hiervan werd een morfologische matrix opgesteld en werd het uiteindelijke concept gekozen.

Voor de app werd een analyse gemaakt van bestaande interfaces, waarna de functies en structuur van de applicatie werden bepaald. Via usertests en een korte workshop met ouders werden de laatste aanpassingen doorgevoerd.

Daarnaast werd de visuele feedback voor kinderen verder verfijnd. In overleg met professor Carton werd besloten dat eenvoudige animaties het opruimgedrag extra konden stimuleren. Verschillende concepten werden uitgewerkt en visueel getest.
